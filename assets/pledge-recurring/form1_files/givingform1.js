...
if (function($, t, e, i) {
    ...
    e.prop("disabled", "disabled"), t.keyup(function() {
        ...
        $(this).attr("type", "text")
    }), $("#prefzip").on("keyup keydown mousedown change mouseenter mouseout", function() {
        var t = $(this);
        5 == t.val().length && is_int(t.val()) && $.ajax({
            //url: "https://zip.getziptastic.com/v2/",
           ...
           /*success: function(t, e) {
                $("#prefcity").val(t.city), $("#prefstate").val(t.state_short), $("#prefcountry").val(t.country)
            }*/
        })
    }), $("#BillZip").on("keyup keydown mousedown change mouseenter mouseout", function() {
        var t = $(this);
        5 == t.val().length && is_int(t.val()) && $.ajax({
          //url: "https://zip.getziptastic.com/v2/",
           // url: "https://zip.getziptastic.com/v2/US/" + t.val(),
          //  cache: !0,
           // dataType: "json",
            ...
            //data: t.val(),
           /* success: function(t, e) {
                $("#BillCity").val(t.city), $("#BillState").val(t.state_short), $("#BillCountry").val(t.country)
            }*/
        })
