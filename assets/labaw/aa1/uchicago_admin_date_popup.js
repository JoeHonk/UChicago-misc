...
(function($) {
    ...
    Drupal.date.EndDatePopupHandler = function (widget) {
        this.$widget = $(widget);
        this.$start = this.$widget.find('.form-type-date-popup[class$="value form-item"]').find('.form-type-textfield[class$="value-date form-item"]').find('input');
        this.$end = this.$widget.find('.form-type-date-popup[class$="value2 form-item"]').find('.form-type-textfield[class$="value2-date form-item"]').find('input');
