...
while ($pagenum <= 1){
    $queryCondition = array(
        ...
        //236935920
        //'QueryText' => 'SELECT OrderID FROM Order WHERE EventID=1144828',
        //'QueryText' => 'SELECT * from Order INNER JOIN OrderDetail on Order.OrderID = OrderDetail.OrderID WHERE EventID=1144828',
        'QueryText' => 'SELECT Order.*, OrderDetail.* from Order, OrderDetail',
        'PageSize' => 100,
        'PageNumber' => $pagenum
        );
...
//echo $total;
$myfile = fopen('./json/'.$eid.'-test.json', "w")or die("Unable to open file!");
if ($total < $lwcmin){
